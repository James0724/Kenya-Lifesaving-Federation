...
export default function ClassAd() {
  ...
  return (
    <div className="class-ad pt-1 pb-5">
      <div className="container">
        <div className="flex flex-column mt-5 mb-5 ">
          <div className="flex flex-column">
            {/* <h3 className="kicker text-center mb-1">Our Classes</h3> */}
            <h1
              className="text-center text-uppercase"
              style={{ color: "#fff" }}
            >
              Perfect Solution for Beginner Swimmer
            </h1>
          </div>
        </div>
